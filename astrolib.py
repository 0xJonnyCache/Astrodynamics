...
def ellipticalTOF(u,e,a,theta1,theta2,k):
    ...
    # The following formula is taken from notes but
...
def lambo(r1, r2, tof, tm, u, errTol=1e-6):
    ...
    if A == 0:
        print("ERROR: can't compute the orbit")
        return
    ...
    # trying to expand psi_low bound.. per a lit review
